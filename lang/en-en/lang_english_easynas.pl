...
$TEXT{'settings_cert_current'} = "Current certificate";
$TEXT{'settings_cert_file'} = "Certificate (PEM)";
$TEXT{'settings_key_file'} = "Private key (PEM, optional)";
$TEXT{'settings_cert_help'} = "Upload a matching certificate and key. The web server restarts to apply them.";
$TEXT{'settings_cert_uploaded'} = "Certificate uploaded. Restarting to apply it...";
$TEXT{'no_cert'} = "No certificate file was provided.";
...
$TEXT{'fs_invalid_name'} = "Invalid name: use only letters, digits, dash and underscore";
$TEXT{'fs_busy'} = "File System is still in use (open files). Close them or restart the sharing services, then try again";
...
$TEXT{'insufficient'} = "Insufficient disks";
...
$TEXT{'raid_converting'} = "Converting the filesystem to the new Raid level in the background. This can take a while.";
$TEXT{'fs_not_mounted'} = "The filesystem must be mounted for this action.";
$TEXT{'fs_balancing'} = "Balancing the filesystem in the background.";
$TEXT{'fs_scrubbing'} = "Scrub started; the filesystem is being verified.";
$TEXT{'fs_repairing'} = "Repair started: a scrub rebuilds bad blocks from redundancy.";
$TEXT{'fs_removing_disk'} = "Removing the disk in the background; its data is being migrated.";
$TEXT{'fs_disk_added'} = "Disk added. Run Balance to spread data across it.";
$TEXT{'fs_failed_adding_disk'} = "Failed to add the disk.";
$TEXT{'fs_replacing_disk'} = "Replacing the disk in the background.";
$TEXT{'fs_add_disk'} = "Add Hard Disk";
$TEXT{'fs_replace_disk'} = "Replace Hard Disk";
$TEXT{'fs_replace_from'} = "Disk to replace";
$TEXT{'fs_select_disk'} = "Select a free disk";
$TEXT{'fs_apply'} = "Apply";
